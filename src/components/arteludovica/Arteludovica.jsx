    ...
    <div className="shadow-2xl bg-negroGris pb-[5rem]">
      <div className=" flex flex-col justify-around py-12 md:px-4 ">
        <div className="flex flex-col md:flex-row md:gap-[8rem]">
          <div>
            <p className="text-5xl text-center md:hidden text-[#e9dcc2] font-extrabold">
              Compañía <br /> Arteludovica
            </p>
            <img
              className="w-[100%] md:w-[44rem] hidden md:block "
              src={tituloLudovica}
              alt=""
            />
          </div>
        ...
        <div className="flex flex-col md:flex-row gap-[3rem]">
          ...
          <Project
            ...
            techInfo={
              "This is the second site I developed with HTML, CSS, and Javascript on the frontend, along with a simple backend developed with PHP and a SQL database. Then I rebuild the site with Next.js and SASS."
            }
