import RetratoDario from "../assets/images/dario.webp";
    ...
    return (
        <div className="md:mb-[12rem]">
            <div className="flex mt-5  ">
                <div className="">
                    <img src={RetratoDario} className="rounded-full w-[8rem] h-[8rem] object-cover border-2 border-titulo md:w-[15rem] md:h-[15rem] " alt="Darío Semino's photo" />
                </div>
