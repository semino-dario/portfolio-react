...
export default function Gerontovida() {
    ...
    const imagenes = [
        ...
        { label: 'edit articles', imgPath: escritorio }, { label: 'publish charts', imgPath: publicarCanasta }, { label: 'canasta y jubilación mínima', imgPath: canastaBarra }, { label: ' canasta torta', imgPath: canastaTorta }]
